...
public class Health extends Kunai{
	
	private int nutrition;
	private Player player;
	public Health(TileMap tm, boolean right,Player player) {
		super(tm, right);
		nutrition = 800;
		this.player = player;
		...
		try {
			...
			for(int i = 0;i <sprites.length;i++){
				sprites[i] = spritesheet.getSubimage(100, 0, width, height);
			}
